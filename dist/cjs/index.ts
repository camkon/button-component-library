...
const Simple = (props) => {
    const [click, setClick] = react.exports.useState('false');
    return React.createElement(Button$1, { action: click, padding: props.padding, borderRadius: props.borderRadius, backgroundColor: props.backgroundColor, fontSize: props.fontSize, 
        // {...props}
        onClick: props.onClick, onMouseDown: () => { setClick('true'); }, onMouseUp: () => { setClick('false'); } }, props.label);
};
